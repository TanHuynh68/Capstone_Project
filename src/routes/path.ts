...
export enum PATH {
    ...
    STAFF_DASHBOARD_MANAGER_USERS = STAFF_ROUTES.STAFF + "/" + STAFF_ROUTES.STAFF_DASHBOARD + "/" + STAFF_ROUTES.STAFF_MANAGER_USERS,
    STAFF_MANAGER_WITHDRAWAL = STAFF_ROUTES.STAFF + "/" + STAFF_ROUTES.STAFF_DASHBOARD + "/" + STAFF_ROUTES.STAFF_MANAGER_WITHDRAWAL
}